...
public class ElasticSearchModule {
    ...
    final static org.slf4j.Logger log = LoggerFactory.getLogger(ElasticSearchModule.class);
    ...
    public ElasticSearchModule(String hostname){
        _hostname = hostname;
        _client = createTransportClient();
    }

    public ElasticSearchModule(String hostname, int port){
        _port = port;
        _hostname = hostname;
        _client = createTransportClient();
    }
...
//    }
    ...
    public String query(String index,String type,String jsonQuery){
        return query(index,type,new JSONObject(jsonQuery));
    }
